...
Click **"New Query"** and paste **ONLY THE SQL BELOW** (scroll down in the code block below):

⚠️ **IMPORTANT**: Do NOT copy the markdown header. Start from `-- ================================================================` and copy everything below.
