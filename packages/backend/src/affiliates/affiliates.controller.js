...
var affiliate_guard_1 = require("./guards/affiliate.guard");
var AffiliatesController = function () {
    var _classDecorators = [(0, common_1.Controller)('affiliates')];
    ...
    var AffiliatesController = _classThis = /** @class */ (function () {
        ...
        AffiliatesController_1.prototype.register = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.affiliatesService.register(dto)];
                });
            });
        };
        /** Login and receive a JWT session */
        AffiliatesController_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.affiliatesService.login(dto.email, dto.password)];
                });
            });
        };
        // ─── Authenticated ────────────────────────────────────────────────────────
        /** Get own affiliate profile */
        AffiliatesController_1.prototype.getMe = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.affiliatesService.getMe(req.affiliate.id)];
                });
            });
        };
        /** Update own profile */
        AffiliatesController_1.prototype.updateMe = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.affiliatesService.updateMe(req.affiliate.id, dto)];
                });
            });
        };
        /** Dashboard stats — total recruits, conversions, earnings */
        AffiliatesController_1.prototype.getDashboard = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.affiliatesService.getDashboard(req.affiliate.id)];
                });
            });
        };
        /** List of all owners recruited */
        AffiliatesController_1.prototype.getReferrals = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.affiliatesService.getReferrals(req.affiliate.id)];
                });
            });
        };
        /** Commission history */
        AffiliatesController_1.prototype.getCommissions = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.affiliatesService.getCommissions(req.affiliate.id)];
                });
            });
        };
    ...
    (function () {
        ...
        _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(affiliate_guard_1.AffiliateGuard)];
        _updateMe_decorators = [(0, common_1.Patch)('me'), (0, common_1.UseGuards)(affiliate_guard_1.AffiliateGuard)];
        _getDashboard_decorators = [(0, common_1.Get)('dashboard'), (0, common_1.UseGuards)(affiliate_guard_1.AffiliateGuard)];
        _getReferrals_decorators = [(0, common_1.Get)('referrals'), (0, common_1.UseGuards)(affiliate_guard_1.AffiliateGuard)];
        _getCommissions_decorators = [(0, common_1.Get)('commissions'), (0, common_1.UseGuards)(affiliate_guard_1.AffiliateGuard)];
