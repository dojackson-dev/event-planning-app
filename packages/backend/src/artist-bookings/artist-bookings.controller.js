...
exports.ArtistBookingsController = void 0;
var common_1 = require("@nestjs/common");
var ArtistBookingsController = function () {
    var _classDecorators = [(0, common_1.Controller)('artist-bookings')];
    ...
    var ArtistBookingsController = _classThis = /** @class */ (function () {
        function ArtistBookingsController_1(artistBookingsService, supabaseService) {
            this.artistBookingsService = (__runInitializers(this, _instanceExtraInitializers), artistBookingsService);
            this.supabaseService = supabaseService;
            this.logger = new common_1.Logger(ArtistBookingsController.name);
        }
        ArtistBookingsController_1.prototype.getUserId = function (authorization) {
        ...
        ArtistBookingsController_1.prototype.createBooking = function (auth, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistBookingsService.createBooking(userId, dto)];
                    }
                });
            });
        };
        /** GET /artist-bookings/mine */
        ArtistBookingsController_1.prototype.listBookings = function (auth) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistBookingsService.listBookings(userId)];
                    }
                });
            });
        };
        /** GET /artist-bookings/:id */
        ArtistBookingsController_1.prototype.getBooking = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistBookingsService.getBooking(userId, id)];
                    }
                });
            });
        };
        /** PUT /artist-bookings/:id */
        ArtistBookingsController_1.prototype.updateBooking = function (auth, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistBookingsService.updateBooking(userId, id, dto)];
                    }
                });
            });
        };
        /** DELETE /artist-bookings/:id */
        ArtistBookingsController_1.prototype.deleteBooking = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistBookingsService.deleteBooking(userId, id)];
                    }
                });
            });
        };
        return ArtistBookingsController_1;
    }());
    __setFunctionName(_classThis, "ArtistBookingsController");
    (function () {
        ...
        ArtistBookingsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ArtistBookingsController = _classThis;
}();
exports.ArtistBookingsController = ArtistBookingsController;
