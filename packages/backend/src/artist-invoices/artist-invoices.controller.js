...
exports.ArtistInvoicesController = void 0;
var common_1 = require("@nestjs/common");
var ArtistInvoicesController = function () {
    var _classDecorators = [(0, common_1.Controller)('artist-invoices')];
    ...
    var ArtistInvoicesController = _classThis = /** @class */ (function () {
        function ArtistInvoicesController_1(artistInvoicesService, supabaseService) {
            this.artistInvoicesService = (__runInitializers(this, _instanceExtraInitializers), artistInvoicesService);
            this.supabaseService = supabaseService;
            this.logger = new common_1.Logger(ArtistInvoicesController.name);
        }
        // ─── Auth helper ──────────────────────────────────────────────────────────
        ArtistInvoicesController_1.prototype.getUserId = function (authorization) {
        ...
        ArtistInvoicesController_1.prototype.getPublicInvoice = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.artistInvoicesService.getPublicInvoice(token)];
                });
            });
        };
        /** POST /artist-invoices/public/:token/checkout — External client initiates payment */
        ArtistInvoicesController_1.prototype.createPublicCheckout = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.artistInvoicesService.createCheckoutSession(token)];
                });
            });
        };
        /** POST /artist-invoices/public/:token/verify-payment — Verify Stripe session and mark paid */
        ArtistInvoicesController_1.prototype.verifyPayment = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.artistInvoicesService.verifyPayment(token)];
                });
            });
        };
        // ─── AUTHENTICATED routes ──────────────────────────────────────────────────
        /** POST /artist-invoices — Create a new invoice */
        ArtistInvoicesController_1.prototype.createInvoice = function (auth, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.createInvoice(userId, dto)];
                    }
                });
            });
        };
        /** GET /artist-invoices/mine — List all invoices for this artist */
        ArtistInvoicesController_1.prototype.listInvoices = function (auth) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.listInvoices(userId)];
                    }
                });
            });
        };
        /** GET /artist-invoices/:id — Get single invoice */
        ArtistInvoicesController_1.prototype.getInvoice = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.getInvoice(userId, id)];
                    }
                });
            });
        };
        /** PUT /artist-invoices/:id — Update invoice metadata */
        ArtistInvoicesController_1.prototype.updateInvoice = function (auth, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.updateInvoice(userId, id, dto)];
                    }
                });
            });
        };
        /** DELETE /artist-invoices/:id — Delete invoice */
        ArtistInvoicesController_1.prototype.deleteInvoice = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.deleteInvoice(userId, id)];
                    }
                });
            });
        };
        /** POST /artist-invoices/:id/send — Email invoice to client */
        ArtistInvoicesController_1.prototype.sendInvoice = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.sendInvoice(userId, id)];
                    }
                });
            });
        };
        /** POST /artist-invoices/:id/items — Add a line item */
        ArtistInvoicesController_1.prototype.addItem = function (auth, id, item) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.addItem(userId, id, item)];
                    }
                });
            });
        };
        /** PUT /artist-invoices/items/:itemId — Update a line item */
        ArtistInvoicesController_1.prototype.updateItem = function (auth, itemId, item) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.updateItem(userId, itemId, item)];
                    }
                });
            });
        };
        /** DELETE /artist-invoices/items/:itemId — Delete a line item */
        ArtistInvoicesController_1.prototype.deleteItem = function (auth, itemId) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.artistInvoicesService.deleteItem(userId, itemId)];
                    }
                });
            });
        };
        return ArtistInvoicesController_1;
    }());
    __setFunctionName(_classThis, "ArtistInvoicesController");
    (function () {
        ...
        ArtistInvoicesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ArtistInvoicesController = _classThis;
}();
exports.ArtistInvoicesController = ArtistInvoicesController;
