...
var AuditController = function () {
    ...
    var _getLog_decorators;
    var AuditController = _classThis = /** @class */ (function () {
        function AuditController_1(auditService, supabaseService) {
            this.auditService = (__runInitializers(this, _instanceExtraInitializers), auditService);
            this.supabaseService = supabaseService;
        }
        AuditController_1.prototype.getOwnerAccountId = function (authorization) {
            return __awaiter(this, void 0, void 0, function () {
                var token, supabase, _a, user, error, admin, membership;
        ...
        AuditController_1.prototype.getLog = function (auth, limit) {
            return __awaiter(this, void 0, void 0, function () {
                var ownerAccountId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getOwnerAccountId(auth)];
                        case 1:
                            ownerAccountId = _a.sent();
                            return [2 /*return*/, this.auditService.getLog(ownerAccountId, Math.min(limit, 500))];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _getLog_decorators = [(0, common_1.Get)('log')];
        __esDecorate(_classThis, null, _getLog_decorators, { kind: "method", name: "getLog", static: false, private: false, access: { has: function (obj) { return "getLog" in obj; }, get: function (obj) { return obj.getLog; } }, metadata: _metadata }, null, _instanceExtraInitializers);
