...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!(body === null || body === void 0 ? void 0 : body.refresh_token)) {
                        throw new common_1.UnauthorizedException('refresh_token is required');
                    }
                    return [2 /*return*/, this.authService.refreshToken(body.refresh_token)];
                });
            });
        };
        AuthController_1.prototype.logout = function (authorization) {
            return __awaiter(this, void 0, void 0, function () {
                var token;
                return __generator(this, function (_a) {
                    if (!authorization) {
        ...
        AuthController_1.prototype.getMe = function (authorization) {
            return __awaiter(this, void 0, void 0, function () {
                var token;
                return __generator(this, function (_a) {
                    if (!authorization) {
                    ...
                    token = authorization.replace('Bearer ', '');
                    return [2 /*return*/, this.authService.getUser(token)];
                });
            });
        };
        AuthController_1.prototype.updateProfile = function (authorization, updateProfileDto) {
            return __awaiter(this, void 0, void 0, function () {
                var token;
                return __generator(this, function (_a) {
                    if (!authorization) {
                    ...
                    token = authorization.replace('Bearer ', '');
                    return [2 /*return*/, this.authService.updateProfile(token, updateProfileDto)];
                });
            });
        };
        AuthController_1.prototype.changePassword = function (authorization, changePasswordDto) {
            return __awaiter(this, void 0, void 0, function () {
                var token;
                return __generator(this, function (_a) {
                    if (!authorization) {
                    ...
                    token = authorization.replace('Bearer ', '');
                    return [2 /*return*/, this.authService.changePassword(token, changePasswordDto)];
                });
            });
        };
        AuthController_1.prototype.deleteAccount = function (authorization) {
            return __awaiter(this, void 0, void 0, function () {
                var token;
                return __generator(this, function (_a) {
                    if (!authorization) {
                    ...
                    token = authorization.replace('Bearer ', '');
                    return [2 /*return*/, this.authService.deleteAccount(token)];
                });
            });
        };
    ...
    (function () {
        ...
        _changePassword_decorators = [(0, common_1.Put)('password')];
        _deleteAccount_decorators = [(0, common_1.Delete)('account')];
