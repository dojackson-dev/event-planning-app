...
exports.RoleGuard = exports.SubscriptionGuard = void 0;
...
var SubscriptionGuard = function () {
    ...
    var _classThis;
    var SubscriptionGuard = _classThis = /** @class */ (function () {
        function SubscriptionGuard_1(supabaseService) {
            this.supabaseService = supabaseService;
        }
        SubscriptionGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, token, supabase, _a, user, error, _b, userData, userError;
        ...
        SubscriptionGuard_1.prototype.extractToken = function (request) {
        ...
        return SubscriptionGuard_1;
    }());
    __setFunctionName(_classThis, "SubscriptionGuard");
    (function () {
...
var RoleGuard = function () {
    ...
    var RoleGuard = _classThis = /** @class */ (function () {
        function RoleGuard_1(supabaseService, reflector) {
            this.supabaseService = supabaseService;
            this.reflector = reflector;
        }
        RoleGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, token, supabase, _a, user, error, userData, requiredRoles;
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (!userData || (requiredRoles && !requiredRoles.includes(userData.role))) {
                                throw new common_1.UnauthorizedException("Required role: ".concat(requiredRoles === null || requiredRoles === void 0 ? void 0 : requiredRoles.join(' or ')));
                            }
                            request.user = userData;
                            return [2 /*return*/, true];
                    }
        ...
        RoleGuard_1.prototype.extractToken = function (request) {
            var authHeader = request.headers.authorization;
            if (!authHeader || !authHeader.startsWith('Bearer ')) {
                return null;
            }
