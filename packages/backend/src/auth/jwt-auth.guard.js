            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            _a = _e.sent(), user = _a.data.user, error = _a.error;
                            if (error || !user) {
                            ...
                            return [4 /*yield*/, supabase
                                    ...
                                    .single()];
                        case 2:
                            _b = _e.sent(), userData = _b.data, userError = _b.error;
                            if (userError || !userData) {
                                throw new common_1.UnauthorizedException('User not found');
                            }
                            // Attach user and owner account ID to request
                            request.user = userData;
                            request.ownerAccountId = ((_d = (_c = userData.memberships) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.owner_account_id) || null;
