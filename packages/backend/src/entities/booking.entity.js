...
var Booking = function () {
    ...
    var Booking = _classThis = /** @class */ (function () {
        function Booking_1() {
            ...
            this.totalPrice = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _totalPrice_initializers, void 0));
            this.deposit = (__runInitializers(this, _totalPrice_extraInitializers), __runInitializers(this, _deposit_initializers, void 0));
            this.paymentStatus = (__runInitializers(this, _deposit_extraInitializers), __runInitializers(this, _paymentStatus_initializers, void 0));
    ...
    (function () {
        ...
        _event_decorators = [(0, typeorm_1.ManyToOne)(function () { return event_entity_1.Event; }), (0, typeorm_1.JoinColumn)({ name: 'eventId' })];
        _eventId_decorators = [(0, typeorm_1.Column)()];
        ...
        _deposit_decorators = [(0, typeorm_1.Column)({ type: 'decimal', precision: 10, scale: 2, nullable: true })];
        _paymentStatus_decorators = [(0, typeorm_1.Column)({ default: 'pending' })];
