...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.ownerId = (__runInitializers(this, _phone_extraInitializers), __runInitializers(this, _ownerId_initializers, void 0)); // References the owner (for customers, planners, and staff)
            this.tenantId = (__runInitializers(this, _ownerId_extraInitializers), __runInitializers(this, _tenantId_initializers, void 0)); // Only for owners who host their website with us (optional)
    ...
    (function () {
        ...
        _tenantId_decorators = [(0, typeorm_1.Column)({ nullable: true })];
