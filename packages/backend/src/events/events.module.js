...
var dev_events_controller_1 = require("./dev-events.controller");
var events_service_1 = require("./events.service");
var supabase_module_1 = require("../supabase/supabase.module");
var useDevEvents = process.env.USE_DEV_EVENTS === 'true';
var eventsControllers = useDevEvents
    ? [dev_events_controller_1.DevEventsController]
