...
var SupabaseService = function () {
    ...
    var SupabaseService = _classThis = /** @class */ (function () {
        function SupabaseService_1(configService) {
            ...
            var supabaseAnonKey = this.configService.get('SUPABASE_ANON_KEY');
            var supabaseServiceKey = this.configService.get('SUPABASE_SERVICE_ROLE_KEY');
        ...
        SupabaseService_1.prototype.setAuthContext = function (accessToken) {
            var supabaseUrl = this.configService.get('SUPABASE_URL');
            var supabaseAnonKey = this.configService.get('SUPABASE_ANON_KEY');
            if (!supabaseUrl || !supabaseAnonKey) {
