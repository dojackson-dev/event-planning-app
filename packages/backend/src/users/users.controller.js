...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        function UsersController_1(usersService, supabaseService) {
            this.usersService = (__runInitializers(this, _instanceExtraInitializers), usersService);
            this.supabaseService = supabaseService;
        }
        UsersController_1.prototype.getAuth = function (authHeader) {
        ...
        UsersController_1.prototype.findAll = function (authHeader) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.usersService.findAll(supabase, ownerId)];
                    }
                });
            });
        };
        UsersController_1.prototype.findOne = function (id, authHeader) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, supabase, ownerId;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), supabase = _a.supabase, ownerId = _a.ownerId;
                            return [2 /*return*/, this.usersService.findOne(supabase, ownerId, id)];
                    }
                });
            });
        };
