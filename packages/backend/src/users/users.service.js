...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.toUser = function (form) {
            var _a;
            // Support both column naming conventions
            var fullName = form.client_name || form.contact_name || '';
            ...
            return {
                ...
                role: 'customer',
                smsOptIn: (_a = form.sms_opt_in) !== null && _a !== void 0 ? _a : false,
                preferredContact: form.preferred_contact || 'phone',
            };
        };
        UsersService_1.prototype.findAll = function (supabase, ownerId) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, data, error, _b, fallback, fallbackError, seen_1, seen;
                var _this = this;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            ...
                            seen_1 = new Set();
                            return [2 /*return*/, (fallback || []).reduce(function (acc, form) {
                                    var key = form.contact_email || form.contact_phone || form.id;
                                    if (!seen_1.has(key)) {
                                        seen_1.add(key);
                                        acc.push(_this.toUser(form));
                                    }
                                    return acc;
                                }, [])];
                        case 3:
                            seen = new Set();
                            return [2 /*return*/, (data || []).reduce(function (acc, form) {
                                    var key = form.contact_email || form.contact_phone || form.id;
                                    if (!seen.has(key)) {
                                        seen.add(key);
                                        acc.push(_this.toUser(form));
        ...
        UsersService_1.prototype.findOne = function (supabase, ownerId, id) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, data, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, data ? this.toUser(data) : null];
                    }
                });
            });
        };
