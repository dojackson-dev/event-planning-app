...
var VendorInvoicesController = function () {
    var _classDecorators = [(0, common_1.Controller)('vendor-invoices')];
    ...
    var _listOwnerBookingInvoices_decorators;
    var _getInvoiceAsOwner_decorators;
    ...
    var VendorInvoicesController = _classThis = /** @class */ (function () {
        function VendorInvoicesController_1(vendorInvoicesService, supabaseService) {
            this.vendorInvoicesService = (__runInitializers(this, _instanceExtraInitializers), vendorInvoicesService);
            this.supabaseService = supabaseService;
            this.logger = new common_1.Logger(VendorInvoicesController.name);
        }
        // ─── Auth helpers ────────────────────────────────────────────────────────────
        VendorInvoicesController_1.prototype.getUserId = function (authorization) {
        ...
        VendorInvoicesController_1.prototype.getOwnerAccountId = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
        ...
        VendorInvoicesController_1.prototype.getPublicInvoice = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.vendorInvoicesService.getPublicInvoice(token)];
                });
            });
        };
        /** POST /vendor-invoices/public/:token/checkout — External client initiates payment */
        VendorInvoicesController_1.prototype.createPublicCheckout = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.vendorInvoicesService.createCheckoutSession(token)];
                });
            });
        };
        /** POST /vendor-invoices/public/:token/verify-payment — Verify Stripe session and mark paid (webhook fallback) */
        VendorInvoicesController_1.prototype.verifyPayment = function (token) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.vendorInvoicesService.verifyPayment(token)];
                });
            });
        };
        // ─── AUTHENTICATED routes ────────────────────────────────────────────────────
        /** POST /vendor-invoices — Create a new invoice */
        VendorInvoicesController_1.prototype.createInvoice = function (auth, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.createInvoice(userId, dto)];
                    }
                });
            });
        };
        /** GET /vendor-invoices/mine — List all invoices for this vendor */
        VendorInvoicesController_1.prototype.listInvoices = function (auth) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.listInvoices(userId)];
                    }
                });
            });
        };
        /** GET /vendor-invoices/owner-bookings — Owner sees invoices they owe vendors */
        VendorInvoicesController_1.prototype.listOwnerBookingInvoices = function (auth) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, this.vendorInvoicesService.listOwnerBookingInvoices(ownerAccountId, userId)];
                    }
                });
            });
        };
        /** GET /vendor-invoices/owner/:id — Owner views a specific vendor invoice they owe */
        VendorInvoicesController_1.prototype.getInvoiceAsOwner = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId, ownerAccountId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (!ownerAccountId)
                                throw new common_1.UnauthorizedException('Not an owner account');
                            return [2 /*return*/, this.vendorInvoicesService.getInvoiceAsOwner(ownerAccountId, id)];
                    }
                });
            });
        };
        /** GET /vendor-invoices/:id — Get single invoice (vendor or owner fallback) */
        VendorInvoicesController_1.prototype.getInvoice = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId, e_1, ownerAccountId;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.getUserId(auth)];
                        ...
                        case 2:
                            _b.trys.push([2, 4, , 7]);
                            return [4 /*yield*/, this.vendorInvoicesService.getInvoice(userId, id)];
                        case 3: return [2 /*return*/, _b.sent()];
                        case 4:
                            e_1 = _b.sent();
                            if (!((e_1 === null || e_1 === void 0 ? void 0 : e_1.status) === 403 || ((_a = e_1 === null || e_1 === void 0 ? void 0 : e_1.constructor) === null || _a === void 0 ? void 0 : _a.name) === 'ForbiddenException')) return [3 /*break*/, 6];
                            return [4 /*yield*/, this.getOwnerAccountId(userId)];
                        case 5:
        ...
        VendorInvoicesController_1.prototype.updateInvoice = function (auth, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.updateInvoice(userId, id, dto)];
                    }
                });
            });
        };
        /** DELETE /vendor-invoices/:id — Delete invoice */
        VendorInvoicesController_1.prototype.deleteInvoice = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.deleteInvoice(userId, id)];
                    }
                });
            });
        };
        /** POST /vendor-invoices/:id/send — Email invoice to client */
        VendorInvoicesController_1.prototype.sendInvoice = function (auth, id) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.sendInvoice(userId, id)];
                    }
                });
            });
        };
        /** POST /vendor-invoices/:id/items — Add a line item */
        VendorInvoicesController_1.prototype.addItem = function (auth, id, item) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.addItem(userId, id, item)];
                    }
                });
            });
        };
        /** PUT /vendor-invoices/items/:itemId — Update a line item */
        VendorInvoicesController_1.prototype.updateItem = function (auth, itemId, item) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.updateItem(userId, itemId, item)];
                    }
                });
            });
        };
        /** DELETE /vendor-invoices/items/:itemId — Delete a line item */
        VendorInvoicesController_1.prototype.deleteItem = function (auth, itemId) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            userId = _a.sent();
                            return [2 /*return*/, this.vendorInvoicesService.deleteItem(userId, itemId)];
                    }
                });
            });
        };
        return VendorInvoicesController_1;
    }());
    __setFunctionName(_classThis, "VendorInvoicesController");
    (function () {
        ...
        _listOwnerBookingInvoices_decorators = [(0, common_1.Get)('owner-bookings')];
        _getInvoiceAsOwner_decorators = [(0, common_1.Get)('owner/:id')];
        ...
        __esDecorate(_classThis, null, _listOwnerBookingInvoices_decorators, { kind: "method", name: "listOwnerBookingInvoices", static: false, private: false, access: { has: function (obj) { return "listOwnerBookingInvoices" in obj; }, get: function (obj) { return obj.listOwnerBookingInvoices; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _getInvoiceAsOwner_decorators, { kind: "method", name: "getInvoiceAsOwner", static: false, private: false, access: { has: function (obj) { return "getInvoiceAsOwner" in obj; }, get: function (obj) { return obj.getInvoiceAsOwner; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        VendorInvoicesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return VendorInvoicesController = _classThis;
}();
