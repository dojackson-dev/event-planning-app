              ...
              <div key={event.id} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                {isExpanded && (
                  <div className="border-t border-gray-100 px-6 py-4 bg-gray-50/50 space-y-4">
                    ...
                    {event.owner && (
                      <div className="mt-4 rounded-lg bg-white border border-primary-100 p-4">
                        <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Your Event Organizer</h4>
                        <div className="flex items-start justify-between gap-4">
                          <div className="space-y-1.5">
                            <p className="text-sm font-semibold text-gray-900">
                              {event.owner.first_name} {event.owner.last_name}
                            </p>
                            {event.owner.phone_number && (
                              <a
                                href={`tel:${event.owner.phone_number}`}
                          ...
                          <Link
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg transition-colors flex-shrink-0"
                          >
