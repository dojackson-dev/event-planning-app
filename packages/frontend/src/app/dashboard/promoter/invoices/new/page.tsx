    ...
    <div className="bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-5">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-3">
          ...
          <button onClick={addItem} className="flex items-center gap-1 text-blue-600 text-sm hover:text-blue-700 font-medium">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-3">
          ...
          <div>
            ...
            <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={2}
              className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm resize-none" placeholder="Optional notes for the client" />
          </div>
          <div>
        ...
        <div className="flex gap-3">
          <button onClick={handleSave} disabled={saving || sending}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-white border border-gray-300 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-50 disabled:opacity-50">
            {saving ? <Loader2 className="w-4 h-4 animate-spin" /> : null}
            Save Draft
          </button>
          <button onClick={handleSaveAndSend} disabled={saving || sending}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-xl text-sm font-medium hover:bg-blue-700 disabled:opacity-50">
...
export default function NewPromoterInvoicePage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center py-24"><Loader2 className="w-8 h-8 animate-spin text-blue-500" /></div>}>
