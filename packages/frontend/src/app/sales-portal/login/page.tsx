            ...
            resetSent ? (
              <div className="text-center py-4">
                ...
                <button type="button" onClick={() => { setForgotMode(false); setResetSent(false) }}
                  className="text-indigo-600 text-sm mt-4 hover:underline">Back to sign in</button>
              </div>
            ) : (
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                <button type="button" onClick={() => setForgotMode(false)}
                  className="w-full text-sm text-gray-500 hover:underline">Back to sign in</button>
              </form>
            )
          ) : (
