        ...
        async (decodedText) => {
          ...
          try {
            ...
            setScanResult({
              ...
              packageName: res.data.order?.vip_packages?.name ?? undefined,
              tableLabel: res.data.order?.vip_packages?.table_label ?? undefined,
              guestsCheckedIn: res.data.guests_checked_in,
